...
const LeftPortion = () => {
  ...
  return (
    <div
      className=" max-sm:w-screen max-sm:h-screen sm:h-screen md:h-[80vh]  sm:w-screen md:w-[32rem] h-96 max-sm:p-12 sm:p-12 flex flex-col  gap-6 text-white md:absolute md:left-[3%] md:top-[20%] md:p-4 md:z-20"
      ref={left}
    >
